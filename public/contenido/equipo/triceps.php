...
array_push($catalogo, array("CL602", "Aparato para tríceps para fondos P/I"));
...
array_push($catalogo, array("CL605", "Aparato para tríceps para fondos movimiento asistido peso libre"));
array_push($catalogo, array("CL606", "Aparato para extensión de tríceps P/L"));
array_push($catalogo, array("CL607", "Aparato para tríceps para fondos mov. asistido P/L"));
